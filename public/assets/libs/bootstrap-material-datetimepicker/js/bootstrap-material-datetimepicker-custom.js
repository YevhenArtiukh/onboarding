(function ($, moment)
{
   ...
   function Plugin(element, options)
   {
      ...
      this.params = {date: true, time: true, format: 'YYYY-MM-DD', minDate: null, maxDate: null, currentDate: null, lang: 'pl', weekStart: 0, disabledDays: [], shortTime: false, clearButton: false, nowButton: false, cancelText: 'Anuluj', okText: 'Zapisz', clearText: 'Wyczyść', nowText: 'Now', switchOnClick: false, triggerEvent: 'focus', monthPicker: false, year:true};
