...
namespace App\Form\Reports\NumberOfParticipants;
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ->add('dateStart', EntityType::class, [
                ...
                'choice_value' => function (?Onboarding $onboarding) {
                    return $onboarding?$onboarding->getDateStart()->format('d.m.Y'): '';
                },
                'placeholder' => '',
                'attr' => [
                    'class' => 'form-control'
